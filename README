...
This is a projecto to participate at the Mozilla Open Leadership project. As tasks to do, we have to create an Open Canvas and a Roadmap for our project. As the original document was a Google presentation, I decided to create a web version, with html and browseable.
